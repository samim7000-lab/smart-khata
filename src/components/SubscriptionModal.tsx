  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        'Faster Receipt & Communication',
        'Limited Automation Placeholders',
        '500 Campaign Recipients',
      ],
    },
    {
      ...
      isRecommended: false,
      features: [
        'Advanced AI Recovery 🚀',
        'AI EMI Recovery & Reminders',
        'AI Campaign Audience Targeting',
        'Advanced Campaign Insights',
        'Higher Automation Placeholders',
